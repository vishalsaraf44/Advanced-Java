				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#welcome" class="active">Student Login Problem</a></li>
			...
			<div>
				<%
	                ...
	                try
	                {
	                    ...
	                    if(rs.next())
	                    {	
							session.setAttribute("name",rs.getString(1).toString());
	                    ...
	                    %>
	                    <div class="about">
	                        <h2 style="color: orange;"><center>Your Acc.No/Password is Incorrect!!</center></h2>
	                    </div>
	                    <%
	                    }
	                }
