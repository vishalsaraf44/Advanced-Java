...
<html lang="en">
<head>
<title>LPU e-Banking | Create Admin Account </title>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#" class="active">Add Admin Account</a></li>
						</ul>	
	...
	<div class="welcome" id="welcome">
		<div class="container">
            ...
            <%
				...
				Long cno=Long.parseLong(request.getParameter("acno"));
				...
				try
				{
					...
					{
						out.println("Not Created.Due to some technical fault.Please Try After Sometime......");
					}
				}
				catch(Exception e)
				{
