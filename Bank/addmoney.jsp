				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#" class="active">Add Money</a></li>
						</ul>	
		...
		<div class="container contact">
			...
			<center><h2>Enter Card Details : </h2></center>
				<form action="add.jsp" method="post">
					Card No. : <input type="text" name="cardno" required pattern="[0-9]*" /><br>
					PIN : <input type="password" name="pin" required pattern="[0-9][0-9][0-9][0-9]" /><br>
					Amount : <input type="text" name="amount" required pattern="[0-9]*" /><br>
