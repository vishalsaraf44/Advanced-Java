...
%>
			...
			<div class="container">		
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<li><a href="" class="active">Pay Fee</a></li>
	...
	<div class="about container">
				...
				String feetype=request.getParameter("reason");
				...
				try
				{
					...
					if(rs1.next())
					{	
						int bcurr_bal=rs1.getInt(2);
						if(amount<=curr_bal)
						{
							int updtbal=bcurr_bal+amount;
							PreparedStatement ps3=con.prepareStatement("update bankaccount set balance=? where accno=?");
							...
							PreparedStatement ps5=con.prepareStatement("insert into transactiontable values(?,?,?)");
							ps5.setInt(1,accno);
							ps5.setString(2,feetype);
							ps5.setInt(3,amount);
