...
<html lang="en">
<head>
<title>LPU e-Banking | Error Login</title>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#welcome" class="active"><b>Admin Portal</b></a></li>
						</ul>	
		...
		<div class="container">
            ...
            <%
				...
				try
				{
					...
					PreparedStatement ps1=con.prepareStatement("select *from admintable where email=? and password=?");
					...
					{
				%>
						<h2 style="color: orange;"><center>Your Email/Password is Incorrect!!</center></h2>
				<%
                	}
				}
				catch(Exception e)
